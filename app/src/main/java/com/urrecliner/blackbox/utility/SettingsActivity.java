...
public class SettingsActivity extends AppCompatActivity  {
    ...
    void setImageSize() {
        ...
        tvSizeDown.setOnClickListener(v -> {
            ...
            tvSize.setText(t);
            editor.putInt(NAME_IMAGES_SIZE, share_image_size).apply();
    ...
    void setSnapInterval() {
        ...
        tvSizeDown.setOnClickListener(v -> {
            ...
            tvSize.setText(t);
            editor.putInt(NAME_SNAP_INTERVAL, (int) share_snap_interval).apply();
        });
        tvSizeUp.setOnClickListener(v -> {
            share_snap_interval++;
            String t = "" + share_snap_interval;
    ...
    void setLeftRight() {
        ...
        String txt = "" + share_left_right;
        tvSize.setText(txt);
        tvSizeDown.setOnClickListener(v -> {
            share_left_right--;
            String t = "" + share_left_right;
            tvSize.setText(t);
            editor.putInt(NAME_LEFT_RIGHT, (int) share_left_right).apply();
        });
        tvSizeUp.setOnClickListener(v -> {
            share_left_right++;
            String t = "" + share_left_right;
...
//        sharedPref = PreferenceManager.getDefaultSharedPreferences(Vars.mContext);
        ...
        if (share_image_size == 0) {
            ...
            editor.putInt(NAME_IMAGES_SIZE, 116);
            editor.putInt(NAME_SNAP_INTERVAL, 197);
            editor.putInt(NAME_LEFT_RIGHT, 100);
            editor.apply();
        } else {
            share_snap_interval = sharedPref.getInt(NAME_SNAP_INTERVAL, 197);
            share_left_right = sharedPref.getInt(NAME_LEFT_RIGHT, 100);
        }
    }
