...
//                mPreviewReader.setOnImageAvailableListener(null, null);
    ...
    private void setCameraSize(StreamConfigurationMap map) {
        ...
        String model = showCameraSizes(map);

        if (model.equals("SM-G950N")) {
            /* galaxy s8
        ...
        else if (model.equals("Lenovo TB-8704F")) {
            /* Lenovo TB-8704F
    ...
    private String showCameraSizes(StreamConfigurationMap map) {
        String model = Build.MODEL;
